...
casosBrasil_final0$`D1 aplicadas` <- NA
casosBrasil_final0$`D2 aplicadas`<- NA
casosBrasil_final0$`DU aplicadas`<- NA
casosBrasil_final0$`D3 aplicadas`<- NA

for (i in 1:length(casosBrasil_final0$date)) {
  if(is.na(casosBrasil_final0$D1[i]=="True")){
    casosBrasil_final0$D1[i]<-0
  }
  if(is.na(casosBrasil_final0$D2[i]=="True")){
    casosBrasil_final0$D2[i]<-0
  }
  if(is.na(casosBrasil_final0$DU[i]=="True")){
    casosBrasil_final0$DU[i]<-0
  }
  if(is.na(casosBrasil_final0$D3[i]=="True")){
    casosBrasil_final0$D3[i]<-0
  }
}


for(i in 2:length(casosBrasil_final0$date)){
  casosBrasil_final0$`D1 aplicadas`[i] <- casosBrasil_final0$D1[i]- casosBrasil_final0$D1[i-1]
  casosBrasil_final0$`D2 aplicadas`[i] <- casosBrasil_final0$D2[i]- casosBrasil_final0$D2[i-1]
  casosBrasil_final0$`DU aplicadas`[i] <- casosBrasil_final0$DU[i]- casosBrasil_final0$DU[i-1]
  casosBrasil_final0$`D3 aplicadas`[i] <- casosBrasil_final0$D3[i]- casosBrasil_final0$D3[i-1]
}

casosBrasil_final0$`D1 aplicadas`[1]= 0
casosBrasil_final0$`D2 aplicadas`[1]= 0
casosBrasil_final0$`DU aplicadas`[1]= 0
casosBrasil_final0$`D3 aplicadas`[1]= 0

#Somando segunda dose + dose unica
casosBrasil_final0$`D2 aplicadas` = casosBrasil_final0$`D2 aplicadas` + casosBrasil_final0$`DU aplicadas`

#base_vacina = casosBrasil_final0 |> 
#  group_by(date) |> 
...
```{r}
casosBrasil_final0$`Primeira dose` <- casosBrasil_final0$`D1 aplicadas`
casosBrasil_final0$`Segunda dose ou dose única` <- casosBrasil_final0$`D2 aplicadas`
...
```{r}
casosBrasil_final0$`Vacinas aplicadas` <- casosBrasil_final0$`D1 aplicadas`
...
```{r}
casosBrasil_final0$`Vacinas aplicadas` <- casosBrasil_final0$`D2 aplicadas`
...
```{r}
casosBrasil_final0$`Vacinas aplicadas` <- casosBrasil_final0$`D3 aplicadas`
...
casosBrasil_final0= casosBrasil_final0 |> 
  filter(date>= "2021-01-01")
casosBrasil_final0$`D1 aplicadas`= as.character(casosBrasil_final0$`D1 aplicadas`)
for (i in 1:length(casosBrasil_final0$`D1 aplicadas`)){
  if(is.na(casosBrasil_final0$`D1 aplicadas`[i]==T)) casosBrasil_final0$`D1 aplicadas`[i]="Nao informado"
}
casosBrasil_final0= dplyr::filter(casosBrasil_final0, D1!="Nao informado")
casosBrasil_final0$`D1 aplicadas`= as.numeric(casosBrasil_final0$`D1 aplicadas`)

casosBrasil_final0$D1_AC= cumsum(casosBrasil_final0$`D1 aplicadas`)
casosBrasil_final0$D2_AC= cumsum(casosBrasil_final0$`D2 aplicadas`)
casosBrasil_final0$D3_AC= cumsum(casosBrasil_final0$`D3 aplicadas`)

casosBrasil_final0$D2_AC= as.character(casosBrasil_final0$D2_AC)
for (i in 1:length(casosBrasil_final0$D2_AC)){
  if((casosBrasil_final0$date[i]<"2021-01-17")) casosBrasil_final0$D2_AC[i]=NA
}
casosBrasil_final0$D2_AC= as.numeric(casosBrasil_final0$D2_AC)

casosBrasil_final0$D3_AC= as.character(casosBrasil_final0$D3_AC)
for (i in 1:length(casosBrasil_final0$D3_AC)){
  if((casosBrasil_final0$date[i]<"2021-08-03")) casosBrasil_final0$D3_AC[i]=NA
}
casosBrasil_final0$D3_AC= as.numeric(casosBrasil_final0$D3_AC)
...
#BaseBrasil_aux = casosBrasil_final0
...
```{r }
casosBrasil_final0$`Aplicações primeira dose` <- casosBrasil_final0$D1_AC
casosBrasil_final0$`Aplicações segunda dose ou dose única` <- casosBrasil_final0$D2_AC
casosBrasil_final0$`Aplicações terceira dose` <- casosBrasil_final0$D3_AC

g6 <- casosBrasil_final0 |> 
